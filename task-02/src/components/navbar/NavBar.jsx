...
export default function Nav() {
    ...
    return (
        <>
            {/* Navbar  */}
            <Navbar
                className="sticky inset-0 z-20 h-max max-w-full border-none rounded-none py-2 px-2 lg:px-8 lg:py-5"
                ...
                <div className="flex items-center justify-between text-blue-gray-900">
                    ...
                    <Link to={'/'}>
                        <Typography
                            as="a"
                            className="mr-7 cursor-pointer py-2.5 text-3xl font-bold flex gap-4 items-center"
                            style={{ color: mode === 'dark' ? 'white' : 'white' }}
                        >
                            {/* Logo Text  */}
                            <span>
